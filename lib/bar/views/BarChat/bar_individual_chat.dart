...
class BarIndividualChat extends StatefulWidget {
  const BarIndividualChat({Key? key}) : super(key: key);

  @override
  _BarIndividualChatState createState() => _BarIndividualChatState();
}

class _BarIndividualChatState extends State<BarIndividualChat> {
  @override
  // void initState() {
  //   super.initState();
