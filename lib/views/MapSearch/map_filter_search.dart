...
class _FilterMapState extends State<FilterMap> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      onModelReady: (model) {
        model.determinePositionFilters();
      },
      ...
      builder: (context, model, child) {
        return
          SafeArea(
            ...
            child: WillPopScope(
              onWillPop: ()async{
                model.filtersMapController.clear();
                model.markers.clear();
                model.address = "";
                return true;
              },
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  model.filtersMapController.text = model.address;
                                  model.navigateBack();
                                },
                          ...
                          FloatingActionButton(
                              elevation: 3,
                              onPressed: () async {
                                var position = await model.determinePositionFilters();
