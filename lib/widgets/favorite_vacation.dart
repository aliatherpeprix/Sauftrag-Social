...
class FavoriteVacation extends StatefulWidget {
  ...
  FavoriteVacation({Key? key, required this.title, required this.btnTxt,}) : super(key: key);

  @override
  _FavoriteVacationState createState() => _FavoriteVacationState();
}

class _FavoriteVacationState extends State<FavoriteVacation> {
  @override
