...
class AddDialogBoxPartyLocation extends StatefulWidget {
  ...
  AddDialogBoxPartyLocation({Key? key, required this.title, required this.btnTxt, required this.icon}) : super(key: key);

  @override
  _AddDialogBoxPartyLocationState createState() => _AddDialogBoxPartyLocationState();
}

class _AddDialogBoxPartyLocationState extends State<AddDialogBoxPartyLocation> {
